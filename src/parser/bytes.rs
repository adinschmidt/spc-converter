...
fn get_slice<'a>(data: &'a [u8], offset: usize, len: usize) -> Result<&'a [u8], ParseError> {
...
pub(crate) fn read_u16_le(data: &[u8], offset: usize) -> Result<u16, ParseError> {
...
pub(crate) fn read_u32_le(data: &[u8], offset: usize) -> Result<u32, ParseError> {
...
pub(crate) fn read_u64_le(data: &[u8], offset: usize) -> Result<u64, ParseError> {
